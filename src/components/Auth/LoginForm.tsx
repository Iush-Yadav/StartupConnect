    ...
    try {
      ...
      if (error) {
        if (error.message.includes('Invalid login credentials')) {
          setError('Account not found. Please register your account first.');
          return;
        }
        throw error;
      }
      ...
      <div className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-lg border border-purple-100">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              id="email"
              required
              className="mt-1 block w-full rounded-lg border-purple-200 shadow-sm focus:border-purple-500 focus:ring-purple-500 bg-white"
        ...
        <div className="mt-6">
          ...
          <button
            ...
            className="mt-6 w-full flex items-center justify-center space-x-2 py-3 px-4 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500"
          >
